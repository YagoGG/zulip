...
def do_create_user(email, password, realm, full_name, active=True,
                   bot_type=None, bot_owner=None, tos_version=None,
    ...
    # type: (Text, Optional[Text], Realm, Text, bool, Optional[int], Optional[UserProfile], Optional[Text], Text, Text, Optional[Stream], Optional[Stream], bool, Optional[PreregistrationUser], Optional[Dict[str, str]]) -> UserProfile
    user_profile = create_user(email=email, password=password, realm=realm,
                               full_name=full_name, active=active,
